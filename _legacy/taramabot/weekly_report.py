"""Weekly signal performance report entrypoint."""
...
async def generate_weekly_report_with_images(
    strategy_name: str | None = None,
) -> tuple[list[str], list]:
    return await generate_performance_report_with_images("weekly", strategy_name)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        for index, image_path in enumerate(image_paths):
            caption = f"<b>{html.escape(bot_label)} Haftalik Performans</b>"
